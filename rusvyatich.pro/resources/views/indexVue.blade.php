...
@include('layouts.metrix')<script type="text/javascript">!function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="https://vk.com/js/api/openapi.js?159",t.onload=function(){VK.Retargeting.Init("VK-RTRG-273901-7YqLn"),VK.Retargeting.Hit()},document.head.appendChild(t)}();</script><noscript><img src="https://vk.com/rtrg?p=VK-RTRG-273901-7YqLn" style="position:fixed; left:-999px;" alt=""/></noscript>
    ...
    <main role="main">
        ...
        <div class="page container">
            ...
            <section id="action" class="action content clearfix">
                ...
                <div class="innerContainer clearfix">
                    ...
                    <ul class="list listCircle leftAboutOrder">
                        <li>Сроки изготовления — от 7-и до 30-и дней.</li>
                        ...
                        <li>Скидка в 10% действует до 20 октября.</li>
                    </ul>
                ...
                <div class="test_svg clearfix svg1740 containerForSvgMain" id="main_test_svg">
                    ...
                    <span id="sumPhone"></span>
                    <span id="sumNewOldPhone"></span>
                    <span id="sumNewPhone">цена:</span>
            ...
            <section  id="individual" class="action content clearfix">
...
<script>
    ...
    var MIN_BLADE_LENGTH = 80;
    var MIN_BLADE_HEIGHT = 20;
    var MIN_BUTT_WIDTH = 2;
    var MIN_HANDLE_LENGTH = 80;
    var MAX_BLADE_LENGTH = 230;
    var MAX_BLADE_HEIGHT = 50;
    var MAX_BUTT_WIDTH = 6;
...
<script type="text/javascript">
        ...
        $().ready(function(){
            ...
            /*Скрол для конструктора*/
                if(device.desktop()) {
                    $('.up_slid_steel').niceScroll('.down_slid_steel',{cursorcolor:'#8a8484',cursoropacitymin:'1', cursorwidth:9, cursorborder:'none', cursorborderradius:0,background: "#e8e8e8",mousescrollstep:15, bouncescroll: false});
                    $('.up_slid_handle').niceScroll('.down_slid_handle',{cursorcolor:'#8a8484',cursoropacitymin:'1', cursorwidth:9, cursorborder:'none', cursorborderradius:0,background: "#e8e8e8",mousescrollstep:25, bouncescroll: false});
                    $('.up_slid_handle_material').niceScroll('.down_slid_handle_material',{cursorcolor:'#8a8484',cursoropacitymin:'1', cursorwidth:9, cursorborder:'none', cursorborderradius:0,background: "#e8e8e8",mousescrollstep:25, bouncescroll: false});
                    $('.up_slid_blade').niceScroll('.down_slid_blade',{cursorcolor:'#8a8484',cursoropacitymin:'1', cursorwidth:9, cursorborder:'none', cursorborderradius:0,background: "#e8e8e8",mousescrollstep:25, bouncescroll: false});
                    $('.up_slid_bolster').niceScroll('.down_slid_bolster',{cursorcolor:'#8a8484',cursoropacitymin:'1', cursorwidth:9, cursorborder:'none', cursorborderradius:0,background: "#e8e8e8",mousescrollstep:25, bouncescroll: false});
                    ...
                    $('.menu').niceScroll('.menu ul',{cursorcolor:'#8a8484',cursoropacitymin:'1', cursorwidth:9, cursorborder:'none', cursorborderradius:0,background: "#e8e8e8",mousescrollstep:25, bouncescroll: false, horizrailenabled: false});
