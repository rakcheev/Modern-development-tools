    ...
    <div class="to_cart" id="to_cart" onclick="tmplKnife(); return false;">
        <span class="Runic" style="position: absolute; top: 67px; left: 12px; font-size: 40px;">В</span>
        ...
        <div id="cart">
            ...
            <div class="wrap_slider">
                ...
                <script id="cartTemplate" type="text/x-jquery-tmpl">
                    <li class="cartElement clearfix" id="in_cart_${id}" onclick="showKnife(${id}); return false;">
                        <img src="{{ asset('img/imgStorage') }}/${link_of_image}" width="143px" height="80px">
                        <span href="#" class="thumbdescription">${name}</span>
                        <span class="costCartElement">${price} р.</span>
                        <div class="remove_from_cart">
                            <button class="window_close removeFromCartButton" onclick="removeFromCart(${id}, event); return false;">
                                удалить
                        </div>
                    </li>
                </script>
