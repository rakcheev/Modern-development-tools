...
class AboutMasterController extends Controller
{
    ...
    public function index($id)
    {
		...
		if ($user->status !== MASTER) return redirect()->route('workersMasterHome');
    	...
    	return view('aboutMaster')->with(['title'=>$title, 'toUser'=>"/home/user", 'ordersLink'=>"/home", 'knifesLink'=>"/home/knifes", 'changeConstructLink'=>"/home/changeConstruct", 'statisticLink'=>"/home/statistic ", 'workersLink'=>'/home/workers' , 'user'=>$user, 'orders'=>$orders, 'captionToTable'=> 'Заказы мастера']);
