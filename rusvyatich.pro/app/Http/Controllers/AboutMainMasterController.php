...
class AboutMainMasterController extends Controller
{

    public function index($id)
    {
        $title = 'Главный мастер №'. $id;
        ...
        if (UserOwn::where('id', $id)->exists()){
        	...
        	return redirect()->route('mainMasters');
        }
		if ($user->status !== MAIN_MASTER) return redirect()->route('mainMasters');
    	...
    	return view('aboutMaster')->with(['title'=>$title, 'toUser'=>"/home/user", 'ordersLink'=>"/home", 'knifesLink'=>"/home/knifes", 'changeConstructLink'=>"/home/changeConstruct", 'statisticLink'=>"/home/statistic ", 'workersLink'=>'/home/workers' , 'user'=>$user, 'orders'=>$orders, 'captionToTable'=> 'Заказы глав. мастера']);
